  ...
  return (
      <TouchableOpacity style={styles.container} activeOpacity={0.8}>
          ...
          <RollingBar interval={3000} defaultStyle={false} customStyle = {styles.textContainer}>
              ...
              <CustomText variant='h6' fontFamily={Fonts.Medium}> Search "for ata, dal "</CustomText>
              <CustomText variant='h6' fontFamily={Fonts.Medium}> Search "chips or coke"</CustomText>
